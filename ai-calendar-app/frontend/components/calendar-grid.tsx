          ...
          {days.map((date, index) => (
            <button
              ...
              className={cn(
                ...
                "hover:bg-muted hover:scale-105 disabled:opacity-0 disabled:cursor-default",
                isToday(date) && "bg-primary/10 font-semibold ring-2 ring-primary/30",
                isSelected(date) && "bg-primary text-primary-foreground hover:bg-primary/90 scale-105",
              )}
            >
              {date && (
                <>
          ...
          {weekDates.map((date, index) => (
            <button
              ...
              className={cn(
                ...
                isToday(date) && "bg-primary/10 ring-2 ring-primary/30",
                isSelected(date) && "bg-primary text-primary-foreground hover:bg-primary/90 scale-105",
              )}
            >
