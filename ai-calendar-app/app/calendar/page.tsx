          ...
          <div className="space-y-6">
            ...
            <Card className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold">Công việc hôm nay</h3>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">15 tháng 12</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Can Chi</span>
                  <span className="font-medium">Giáp Thìn</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Giờ hoàng đạo</span>
                  <span className="font-medium">7h-9h, 13h-15h</span>
                </div>
                <div className="pt-3 border-t border-border">
                  <Badge variant="secondary" className="bg-secondary/10 text-secondary">
                    Ngày tốt: Khai trương, ký hợp đồng
                  </Badge>
                </div>
              </div>
            </Card>
