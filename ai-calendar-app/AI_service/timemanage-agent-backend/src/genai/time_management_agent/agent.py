...
from .subgraphs.add_task_subgraph import build_add_task_subgraph
from .subgraphs.get_tasks_subgraph import build_get_tasks_subgraph
...
SUBGRAPH_PATH_MAP = {
    ...
    "add_task":"add_task_subgraph",
    "get_tasks":"get_tasks_subgraph"
}
...
def build_graph():
    ...
    graph.add_node("add_task_subgraph", build_add_task_subgraph())
    graph.add_node("get_tasks_subgraph", build_get_tasks_subgraph())
